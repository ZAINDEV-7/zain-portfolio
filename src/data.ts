...
export const projects: Project[] = [
  ...
  { number: '02', title: 'Ortho Dental', type: 'Web / Healthcare', description: 'Modern dental practice website designed to build trust, showcase treatments, and make it easier for patients to discover and contact the clinic.', image: 'https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&fit=crop&w=1800&q=90', tags: ['Next.js', 'UX/UI', 'Responsive Web'], details: 'A professional healthcare web experience focused on clear treatment presentation, trust, and responsive browsing.', projectType: 'Client project', liveUrl: 'https://orthodentals.netlify.app/' },
  ...
  { number: '04', title: 'Roast Ritual', type: 'Web / Coffee', description: 'Warm, atmospheric coffee brand website designed to make the menu, story, and daily ritual feel inviting across every screen.', image: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=1800&q=90', tags: ['Branding', 'React', 'Responsive Web'], details: 'A coffee-focused web experience built around product discovery, brand atmosphere, and an inviting customer journey.', projectType: 'Client project', liveUrl: 'https://roast-ritual.netlify.app/' },
  { number: '05', title: 'Legends Gym', type: 'Web / Fitness', description: 'High-energy fitness website designed to showcase programs, build a strong digital identity, and turn visitors into potential members.', image: 'https://legends-gym.netlify.app/assets/hero-gym-D4YCLO0s.jpg', tags: ['Branding', 'React', 'Responsive Web', 'Motion'], details: 'A fitness-focused web experience built around a strong visual identity, program discovery, and a clear membership journey.', projectType: 'Client project', liveUrl: 'https://legends-gym.netlify.app/' },
  { number: '06', title: 'Crema Coffee House', type: 'Web / Coffee', description: 'Modern coffee house website created to showcase the menu, atmosphere, and personality of a neighborhood destination.', image: 'https://crema-coffee-house.netlify.app/img/hero-1.jpg', tags: ['Branding', 'UX/UI', 'Responsive Web'], details: 'A coffee house web experience focused on menu presentation, atmosphere, and making it easy for visitors to plan a visit.', projectType: 'Client project', liveUrl: 'https://crema-coffee-house.netlify.app/' },
]
